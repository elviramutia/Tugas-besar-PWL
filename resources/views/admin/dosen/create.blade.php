                    ...
                    <form action="{{ route('admin.dosen.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nidn" value="{{ old('nidn') }}" class="pl-10 block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required maxlength="10" placeholder="Masukkan 10 digit NIDN">
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama') }}" class="pl-10 block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required maxlength="50" placeholder="Contoh: Dr. Budi Santoso, M.Kom">
                                </div>
                        ...
                        <div class="relative py-4">
                            ...
                            <div class="relative flex justify-center">
                                <span class="bg-white px-4 text-sm font-semibold text-rose-600 bg-rose-50 rounded-full py-1">Kelola Akun (Opsional)</span>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" class="pl-10 block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" placeholder="Opsional">
                                </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" name="password" class="pl-10 block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" placeholder="Opsional">
                                </div>
