...
<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Dosen</h2></x-slot>
    <div class="py-12"><div class="max-w-2xl mx-auto sm:px-6 lg:px-8"><div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
        <form action="{{ route('admin.dosen.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nidn" value="{{ old('nidn') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required maxlength="10">
            ...
            <p class="text-sm text-gray-500 mb-4">Isi bagian ini jika Anda ingin mengatur email dan kata sandi kustom untuk akun dosen ini. Biarkan kosong untuk menggunakan nilai bawaan (Email: [NIDN]@siakad.com, Password: password).</p>
