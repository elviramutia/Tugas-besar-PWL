            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <a href="{{ route('admin.matakuliah.create') }}" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">Tambah Mata Kuliah</a>
                        <form method="GET" action="{{ route('admin.matakuliah.index') }}" class="flex">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari mata kuliah..." class="border-gray-300 rounded-l-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
