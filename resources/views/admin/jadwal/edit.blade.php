                    ...
                    <form action="{{ route('admin.jadwal.update', $jadwal->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <select name="kode_matakuliah" class="block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="nidn" class="block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
                        ...
                        <div class="bg-rose-50/30 p-6 rounded-2xl border border-rose-50/50 mt-6">
                            <h3 class="text-sm font-semibold text-rose-900 mb-4 uppercase tracking-wider">Detail Kelas & Waktu</h3>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold text-gray-700">Kelas</label>
                                    <select name="kelas" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="angkatan" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="hari" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="time" name="jam" value="{{ old('jam', date('H:i', strtotime($jadwal->jam))) }}" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-rose-500 focus:ring-rose-500 transition-colors duration-200" required>
