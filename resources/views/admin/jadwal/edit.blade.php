<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <div class="p-2 bg-indigo-100 text-indigo-600 rounded-lg shadow-sm">
                    ...
                    <form action="{{ route('admin.jadwal.update', $jadwal->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <select name="kode_matakuliah" class="block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="nidn" class="block w-full rounded-xl border-gray-200 bg-gray-50/50 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                        ...
                        <div class="bg-indigo-50/30 p-6 rounded-2xl border border-indigo-50/50 mt-6">
                            <h3 class="text-sm font-semibold text-indigo-900 mb-4 uppercase tracking-wider">Detail Kelas & Waktu</h3>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold text-gray-700">Kelas</label>
                                    <select name="kelas" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="angkatan" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="hari" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="time" name="jam" value="{{ old('jam', date('H:i', strtotime($jadwal->jam))) }}" class="block w-full rounded-xl border-gray-200 bg-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200" required>
                        ...
                        <div class="flex items-center justify-end gap-4 pt-4 mt-6 border-t border-gray-100">
                            ...
                            <button type="submit" class="px-6 py-2.5 rounded-xl font-medium text-white bg-indigo-600 hover:bg-indigo-700 hover:shadow-lg hover:-translate-y-0.5 focus:ring-4 focus:ring-indigo-200 transition-all duration-200 flex items-center gap-2">
