                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex gap-3">
                            ...
                            <a href="{{ route('dosen.absensi.create', $jadwal->id) }}" class="inline-flex items-center gap-1 bg-indigo-600 text-white px-4 py-2 rounded-lg font-bold text-sm shadow-md hover:bg-indigo-700 hover:shadow-lg transition-all focus:ring-2 focus:ring-indigo-500 focus:outline-none">
