<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <!-- Bottom Section: Calendar or Quick Lists -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <!-- Schedule Item -->
                    <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                        <div class="w-12 h-12 rounded-lg bg-orange-50 flex flex-col items-center justify-center text-orange-700 flex-shrink-0">
                     ...
                     <!-- Schedule Item -->
                    <div class="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                        <div class="w-12 h-12 rounded-lg bg-blue-50 flex flex-col items-center justify-center text-blue-700 flex-shrink-0">
